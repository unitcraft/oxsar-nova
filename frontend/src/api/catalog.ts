...
export const SHIPS: CombatEntry[] = [
  ...
  { id: 325, key: 'shadow_ship',      name: 'Корабль-призрак',    attack: 200,    shield: 30,    shell: 4000,    cargo: 75,      speed: 13000,     fuel: 35,   cost: { metal: 1000,    silicon: 3000,   hydrogen: 1000    }, requires: [{ kind: 'building', key: 'shipyard', level: 4 }, { kind: 'research', key: 'masking_tech', level: 3 }], description: 'Стелс-корабль с anti-DS ролью — высокая маскировка',                                                                                                                                                       front: 7,  ballistics: 5, masking: 5, rapidfire: { 30: 15, 31: 5, 35: 20, 36: 20, 37: 30, 40: 25, 41: 15, 42: 70 } },
