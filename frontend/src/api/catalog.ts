...
export const SHIPS: CombatEntry[] = [
  { id: 29, key: 'small_transporter', name: 'Малый транспорт',    attack: 5,      shield: 10,    shell: 4000,    cost: { metal: 2000,    silicon: 2000,   hydrogen: 0       } },
  { id: 30, key: 'large_transporter', name: 'Большой транспорт',  attack: 5,      shield: 25,    shell: 12000,   cost: { metal: 6000,    silicon: 6000,   hydrogen: 0       } },
  { id: 31, key: 'light_fighter',     name: 'Легкий истребитель', attack: 50,     shield: 10,    shell: 4000,    cost: { metal: 3000,    silicon: 1000,   hydrogen: 0       } },
  { id: 32, key: 'strong_fighter',    name: 'Тяжелый истребитель',attack: 150,    shield: 25,    shell: 10000,   cost: { metal: 6000,    silicon: 4000,   hydrogen: 0       } },
  { id: 33, key: 'cruiser',           name: 'Крейсер',            attack: 400,    shield: 50,    shell: 27000,   cost: { metal: 20000,   silicon: 7000,   hydrogen: 2000    } },
  { id: 34, key: 'battle_ship',       name: 'Линкор',             attack: 1000,   shield: 200,   shell: 60000,   cost: { metal: 45000,   silicon: 15000,  hydrogen: 0       } },
  { id: 36, key: 'colony_ship',       name: 'Колонизатор',        attack: 50,     shield: 100,   shell: 30000,   cost: { metal: 10000,   silicon: 20000,  hydrogen: 10000   } },
  { id: 37, key: 'recycler',          name: 'Переработчик',       attack: 1,      shield: 10,    shell: 16000,   cost: { metal: 12500,   silicon: 2500,   hydrogen: 10000   } },
  { id: 38, key: 'espionage_sensor',  name: 'Шпионский зонд',     attack: 0,      shield: 0,     shell: 1000,    cost: { metal: 0,       silicon: 1000,   hydrogen: 0       } },
  { id: 39, key: 'solar_satellite',   name: 'Солнечный спутник',  attack: 1,      shield: 1,     shell: 2000,    cost: { metal: 0,       silicon: 2000,   hydrogen: 500     } },
  { id: 40, key: 'bomber',            name: 'Бомбардировщик',     attack: 1000,   shield: 500,   shell: 75000,   cost: { metal: 50000,   silicon: 25000,  hydrogen: 15000   } },
  { id: 42, key: 'death_star',        name: 'Звезда смерти',      attack: 200000, shield: 50000, shell: 9000000, cost: { metal: 5000000, silicon: 4000000,hydrogen: 1000000 } },
];
