...
export const RESEARCH: ResearchEntry[] = [
  ...
  { id: 26,  key: 'ign',               name: 'Гравитонная технология (IGN)',          benefit: 'требование для линкоров',                  fullDesc: 'Технология объединения граничных полей открывает доступ к высоким боевым кораблям.',                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  costBase: { metal: 0,     silicon: 0,     hydrogen: 0    }, costFactor: 2.0,  requires: [{ kind: 'building', key: 'research_lab', level: 1 }] },
  { id: 28,  key: 'gravi',             name: 'Гравитонная пушка',                    benefit: 'требование для Звезды смерти',             fullDesc: 'Гравитонная пушка стреляет ускоренными гравитонами. Сильно сжатый пучок гравитонов вызывает мощное гравитационное поле, способное полностью разрушить большие космические корабли при попадании. Гравитонная пушка является обязательной для постройки Звезды смерти.',                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            costBase: { metal: 0,     silicon: 0,     hydrogen: 0    }, costFactor: 3.0,  requires: [{ kind: 'building', key: 'research_lab', level: 12 }, { kind: 'research', key: 'energy_tech', level: 12 }] },
  { id: 112, key: 'astro_tech',        name: 'Астрофизика',                          benefit: '+1 слот колонии и экспедиции',             fullDesc: 'Астрофизика позволяет колонизировать дальние планеты и проводить больше одновременных экспедиций. Каждый уровень увеличивает максимальное количество колоний и слотов экспедиции.',                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  costBase: { metal: 4000,  silicon: 8000,  hydrogen: 4000 }, costFactor: 1.75, requires: [{ kind: 'building', key: 'research_lab', level: 3 }, { kind: 'research', key: 'impulse_engine', level: 3 }, { kind: 'research', key: 'spyware', level: 4 }] },
  { id: 113, key: 'igr_tech',          name: 'Межгалактическая исследовательская сеть', benefit: 'объединяет лаборатории планет',          fullDesc: 'Межгалактическая исследовательская сеть позволяет лабораториям с разных планет работать над одной технологией. Каждый уровень добавляет одну лабораторию в общий пул — суммарный уровень снижает время исследований.',                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          costBase: { metal: 240000, silicon: 400000, hydrogen: 160000 }, costFactor: 2.0, requires: [{ kind: 'building', key: 'research_lab', level: 10 }, { kind: 'research', key: 'computer_tech', level: 8 }, { kind: 'research', key: 'hyperspace_tech', level: 8 }] },
...
export const SHIPS: CombatEntry[] = [
  ...
  { id: 41, key: 'star_destroyer',    name: 'Звёздный разрушитель', attack: 2000, shield: 500,   shell: 110000,  cargo: 2000,    speed: 5000,      fuel: 1000, cost: { metal: 60000,   silicon: 50000,  hydrogen: 15000   }, requires: [{ kind: 'building', key: 'shipyard', level: 9 }, { kind: 'research', key: 'hyperspace_tech', level: 5 }, { kind: 'research', key: 'hyperspace_engine', level: 6 }, { kind: 'research', key: 'gun_tech', level: 7 }], description: 'Тяжёлый боевой корабль выше класса линкора',                                                       front: 10, ballistics: 0, masking: 0 },
  ...
  { id: 52, key: 'interplanetary_missile', name: 'Межпланетная ракета', attack: 0, shield: 0,    shell: 1500,    cargo: 0,       speed: 12000,     fuel: 1,    cost: { metal: 12500,   silicon: 2500,   hydrogen: 10000   }, requires: [{ kind: 'building', key: 'missile_silo', level: 1 }, { kind: 'research', key: 'impulse_engine', level: 1 }], description: 'Запускается через ракетную шахту — наносит урон обороне на цели',                                                                                                                                  front: 10, ballistics: 0, masking: 0 },
  { id: 102, key: 'lancer_ship',      name: 'Лансер',             attack: 5500,   shield: 200,   shell: 10000,   cargo: 200,     speed: 8000,      fuel: 100,  cost: { metal: 15000,   silicon: 35000,  hydrogen: 60000   }, requires: [{ kind: 'building', key: 'shipyard', level: 7 }, { kind: 'research', key: 'hyperspace_tech', level: 5 }], description: 'Премиум-корабль с высокой атакой — атакует раньше обычных',                                                                                                                                              front: 8,  ballistics: 0, masking: 0, rapidfire: { 42: 3 } },
  { id: 325, key: 'shadow_ship',      name: 'Корабль-призрак',    attack: 30,     shield: 30,    shell: 4000,    cargo: 75,      speed: 13000,     fuel: 35,   cost: { metal: 8000,    silicon: 4000,   hydrogen: 1500    }, requires: [{ kind: 'building', key: 'shipyard', level: 4 }, { kind: 'research', key: 'masking_tech', level: 3 }], description: 'Стелс-корабль для разведки — высокая маскировка',                                                                                                                                                       front: 9,  ballistics: 3, masking: 4 },
  // Корабли пришельцев (200-204) — не строятся игроком, появляются в AI-атаках.
  { id: 200, key: 'unit_a_corvette',  name: 'Корвет пришельцев',     attack: 200,  shield: 75,    shell: 25500,   cargo: 300,     speed: 20000,     fuel: 150,  cost: { metal: 6000,    silicon: 3000,   hydrogen: 1500    }, description: 'Корабль AI — не строится игроком',                                                                                                                                                                                                                                                                            front: 10, ballistics: 0, masking: 0 },
  { id: 201, key: 'unit_a_screen',    name: 'Прикрытие пришельцев',  attack: 22,   shield: 5000,  shell: 30000,   cargo: 800,     speed: 10000,     fuel: 75,   cost: { metal: 8000,    silicon: 6000,   hydrogen: 2000    }, description: 'Корабль AI — не строится игроком',                                                                                                                                                                                                                                                                            front: 10, ballistics: 0, masking: 0 },
  { id: 202, key: 'unit_a_paladin',   name: 'Паладин пришельцев',    attack: 75,   shield: 50,    shell: 4200,    cargo: 50,      speed: 8000,      fuel: 20,   cost: { metal: 1500,    silicon: 1000,   hydrogen: 0       }, description: 'Корабль AI — не строится игроком',                                                                                                                                                                                                                                                                            front: 10, ballistics: 0, masking: 0 },
  { id: 203, key: 'unit_a_frigate',   name: 'Фрегат пришельцев',     attack: 1250, shield: 150,   shell: 70000,   cargo: 2000,    speed: 10000,     fuel: 300,  cost: { metal: 25000,   silicon: 15000,  hydrogen: 5000    }, description: 'Корабль AI — не строится игроком',                                                                                                                                                                                                                                                                            front: 10, ballistics: 0, masking: 0 },
  { id: 204, key: 'unit_a_torpedocarier', name: 'Торпедоносец пришельцев', attack: 350, shield: 100, shell: 11000, cargo: 200,    speed: 13000,     fuel: 100,  cost: { metal: 4000,    silicon: 2500,   hydrogen: 500     }, description: 'Корабль AI — не строится игроком',                                                                                                                                                                                                                                                                            front: 10, ballistics: 0, masking: 0 },
];
...
export const DEFENSE: CombatEntry[] = [
  ...
  { id: 46, key: 'ion_gun',         name: 'Ионное орудие',        attack: 150,  shield: 500,   shell: 8000,    cost: { metal: 8000,  silicon: 2000, hydrogen: 500  }, requires: [{ kind: 'building', key: 'defense_factory', level: 4 }, { kind: 'research', key: 'ion_tech', level: 4 }], description: 'Высокий щит делает её устойчивой против обычных атак', front: 10, ballistics: 0, masking: 0 },
