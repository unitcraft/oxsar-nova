...
<table class="ntable">
	...
	<tfoot><tr>
		<td colspan="6">{if[count($this->getLoop("buddylist")) > 0]}<input type="submit" name="delete" value="{lang}REMOVE{/lang}" class="button" />{else}{lang}NO_MATCHES_FOUND{/lang}{/if}</td>
	</tr></tfoot>
