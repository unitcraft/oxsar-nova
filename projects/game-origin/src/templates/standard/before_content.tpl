	...
	<?php
		...
		if(!defined('SN'))
		{
			$msg = array_merge($msg, array(
				...
				'<a href="Referral">Получай за реферала <font color = "#00FF00"><b>20% кредитов пожизненно</b></font> ;)</a>',
				'<a href="Referral"><font color = "#00FF00">Сделай доброе дело, приведи друга в игру :)</font></a>',
				'<a href="Referral"><font color = "#00FF00">Приводя в игру друзей, ты помогаешь своей любимой игре!</font></a>',
				'<a href="Referral"><font color = "#00FF00">Приводя в игру друзей, ты помогаешь игре!</font></a>',
