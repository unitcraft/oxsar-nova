<table class="ntable">
	...
	{if[count($this->getLoop("relations")) <= 0]}<tr>
...
<table class="ntable">
	...
	<tr>
		...
		<td><select name="status" id="status"><!--<option value="0">{lang}SEND_MESSAGE{/lang}</option>--><option value="1">{lang}PROTECTION{/lang}</option><option value="2">{lang}CONFEDERATION{/lang}</option><option value="3">{lang}WAR{/lang}</option><option value="4">{lang}TRADE_AGREEMENT{/lang}</option><option value="5">{lang}CEASEFIRE{/lang}</option></select></td>
	</tr>
	<tr>
