...
* @version $Id: XML.util.class.php 23 2010-04-03 19:08:34Z craft $
*/
...
class XML
{
  ...
  */
  protected function initParser()
  {
    ...
    {
      throw new GenericException("The supplied data is not a valid XML file.");
    }
    // Hook::event("XML_PARSER_OBJECT", array(&$this));
    return $this;
  }
  ...
  */
  public function setData($data)
  {
    ...
    $this->data = $data;
    // Hook::event("XML_PARSER", array(&$this));
    $this->initParser();
