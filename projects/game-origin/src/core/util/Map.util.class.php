...
* @version $Id: Map.util.class.php 23 2010-04-03 19:08:34Z craft $
*/
...
class Map extends Type implements IteratorAggregate
{
  ...
  */
  public function current()
  {
    ...
    {
      throw new IssueException("Iterator is not initialized. Please call next() first.");
    }
  ...
  */
  public function prev()
  {
    if(is_null($this->iterator))
    {
      throw new IssueException("Iterator is not initialized. Please call end() first.");
    }
    if(isset($this->map[$this->iterator-1]))
    {
      $this->iterator--;
