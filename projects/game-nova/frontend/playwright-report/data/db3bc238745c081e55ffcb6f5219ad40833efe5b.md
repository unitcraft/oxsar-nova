...
- Name: domains/screens.spec.ts >> Ф.2.1 repair >> repair opens for bob
...
- generic [ref=e3]:
  ...
  - generic [ref=e44]:
    ...
    - main [ref=e139]:
      - generic [ref=e140]:
        - generic [ref=e141]:
          - heading "Ремонтный ангар — Bob-Home" [level=2] [ref=e142]
          - generic [ref=e144]:
            - generic [ref=e145]: Хранилище
            - generic [ref=e146]: 0 / 300
        - generic [ref=e149]:
          - button "🔧 Ремонт (0)" [pressed] [ref=e150] [cursor=pointer]
          - button "♻️ Разбор" [ref=e151] [cursor=pointer]
        - generic [ref=e152]: 🔧 Нет повреждённых кораблей
  - contentinfo [ref=e153]: oxsar-nova v0.1.0 — dev preview
```
