...
- Name: edges/resilience.spec.ts >> Ф.4.1 network errors >> 500 from server — user sees something, not a white screen
- Location: e2e/edges/resilience.spec.ts:8:3
...
- generic [ref=e3]:
  ...
  - generic [ref=e44]:
    ...
    - main [ref=e139]
  - contentinfo [ref=e156]: oxsar-nova v0.1.0 — dev preview
```
