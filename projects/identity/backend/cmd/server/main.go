...
import (
	...
	"oxsar/identity/internal/identitysvc"
	"oxsar/identity/internal/httpx"
	"oxsar/identity/internal/moderation"
	"oxsar/identity/internal/storage"
	"oxsar/identity/pkg/jwtrs"
	"oxsar/identity/pkg/metrics"
)
...
func run() error {
	...
	if keyAutogen {
		log.WarnContext(ctx, "IDENTITY_KEY_AUTOGEN=1 — RSA key auto-generated if missing (DEV ONLY)",
