...
// --- ORIGIN /repair ---
{
  ...
  await page.goto(`${ORIGIN_URL}/repair`, { waitUntil: 'networkidle' });
  await page.waitForTimeout(3000);
  await page.screenshot({ path: `${OUT}/origin_repair.png`, fullPage: true });
  console.log('origin /repair saved');
...
// --- LEGACY Repair ---
{
  ...
  await page.goto(`${LEGACY_URL}/game.php?go=Repair`, { waitUntil: 'domcontentloaded' });
  await page.waitForTimeout(3000);
  await page.screenshot({ path: `${OUT}/legacy_repair.png`, fullPage: true });
  console.log('legacy Repair saved');
