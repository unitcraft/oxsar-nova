...
> **Удалено из game-origin в плане 60** (2026-04-28). Параметры
> ниже — историческая справка legacy oxsar2. Новая реферальная
> программа реализуется на portal-backend (план 59) с нуля.
