...
`projects/game-legacy-php/composer.json` не содержит внешних зависимостей —
...
В `projects/game-legacy-php/public/js/tiny_mce/` лежал **TinyMCE под
...
(`projects/game-legacy-php/public/js/tiny_mce/` ≈ 430 МБ) +
...
Проверено grep'ом по `projects/game-legacy-php/src/` и `public/`:
