...
`projects/game-origin-php/composer.json` не содержит внешних зависимостей —
...
В `projects/game-origin-php/public/js/tiny_mce/` лежал **TinyMCE под
...
(`projects/game-origin-php/public/js/tiny_mce/` ≈ 430 МБ) +
...
Проверено grep'ом по `projects/game-origin-php/src/` и `public/`:
