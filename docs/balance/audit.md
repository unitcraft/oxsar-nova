...
- **Статус**: **частично patched** 2026-04-24 (план 18 Фаза 1 применена — rapidfire портирован). Ожидает симуляции перед окончательным patched.
...
- **Серьёзность**: P0
- **Статус**: **частично patched** 2026-04-24 (план 18 Фаза 1 применена: Lancer теперь контрится LF×20, SF×20, Cruiser×35, DS×100). Ожидает симуляции — возможно, прямого нерфа цены (план 21 блок A) уже не понадобится.
