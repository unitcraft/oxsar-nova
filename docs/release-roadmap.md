...
✅ 18 Фаза 1 (rapidfire-порт, 2026-04-24) → симуляция → перепроверить план 21 → 21 B (экспедиции) → 20 Ф.2 (fleet slots) → 20 Ф.1 (vacation) → 17 A1 (антибашинг) → [по результатам симуляции] 18 Фаза 2 / 21 A (Lancer cost, если нужно)
