...
✅ 18 Фаза 1 (rapidfire-порт, 2026-04-24) → ✅ симуляция ([результаты](balance/simulation-2026-04-24.md)) → **21 A** (Lancer cost — подтверждён симуляцией) → 21 B (экспедиции) → 20 Ф.2 (fleet slots) → 20 Ф.1 (vacation) → 17 A1 (антибашинг). 18 Фаза 2 **не нужна** — DS endgame снят симуляцией.
