...
> **Примечание (2026-04-27)**: статусы планов в таблице выше могут
> отставать от реальности (планы 39, 40, 41, 42, 43, 44, 46, 47, 49
> закрыты по факту). Актуальные статусы — в memory `completed_plans.md`
> и в шапках самих планов. Полный sync таблицы — отдельная задача.
>
> **Аудит юр-соответствия от 2026-04-27** —
> [docs/ops/legal-compliance-audit.md](ops/legal-compliance-audit.md).
> Найдено 8 gap'ов, 7 из них покрыты планом
> [50-game-origin-legal-fix.md](plans/50-game-origin-legal-fix.md)
> (legacy-вселенная game-origin: LGPL TinyMCE, отсутствие 152/436/149-ФЗ
> обвязки в legacy-вёрстке, copyright ликвидированной компании).
