...
Реестр **игровых** дыр в `projects/game-origin-php/` (баланс/механика, не безопасность).
...
([src/game/NS.class.php:1816-1834](../../projects/game-origin-php/src/game/NS.class.php#L1816-L1834)):
...
- **Статус**: **patched** (атомарный status-update в начале метода)
- **Где**: [src/game/Exchange.class.php:467-549](../../projects/game-origin-php/src/game/Exchange.class.php#L467-L549)
- **Verification**:
...
- **Статус**: **patched** (см. фикс ниже), исходно isFirstRun отсутствовал
- **Где**: [src/game/page/Market.class.php:192-240](../../projects/game-origin-php/src/game/page/Market.class.php#L192-L240),
  [src/game/NS.class.php:1657-1669](../../projects/game-origin-php/src/game/NS.class.php#L1657-L1669)
- **Verification**:
...
- **Серьёзность**: P1
- **Статус**: **patched** (NS::acquireLock TTL=5s в начале каждого upgrade-метода)
- **Где**:
  - [src/game/page/Research.class.php:356-475](../../projects/game-origin-php/src/game/page/Research.class.php#L356-L475) (`upgradeResearch`)
  - [src/game/page/Constructions.class.php:366-498](../../projects/game-origin-php/src/game/page/Constructions.class.php#L366-L498) (`upgradeConstruction`)
  - [src/game/page/Shipyard.class.php:430-555](../../projects/game-origin-php/src/game/page/Shipyard.class.php#L430-L555) (build flow)
...
- **Серьёзность**: P1
- **Статус**: verified, **отложен после плана 43** (composer-замена Recipe).
  Рефакторинг трогает все списания ресурсов; имеет смысл делать на чистой
  инфраструктуре с Doctrine DBAL (атомарные транзакции через DBAL — естественнее).
- **Где**: [src/game/NS.class.php:1564-1644](../../projects/game-origin-php/src/game/NS.class.php#L1564-L1644)
...
- **Статус**: **patched** (см. фикс ниже)
- **Где**: [src/game/EventHandler.class.php:553-813](../../projects/game-origin-php/src/game/EventHandler.class.php#L553-L813)
- **Verification**:
...
- **Где**: [src/game/EventHandler.class.php:946-947](../../projects/game-origin-php/src/game/EventHandler.class.php#L946-L947)
...
- **Серьёзность**: P2 (понижено с P1 — частично закрыто, но cleanup
  не делает recovery)
- **Статус**: **patched (частично — порог 14d→3d)**, recovery остаётся отдельной задачей
- **Где**: [src/game/EventHandler.class.php:822-834](../../projects/game-origin-php/src/game/EventHandler.class.php#L822-L834)
...
- **Статус**: **patched** (см. фикс ниже)
- **Где**: [src/game/EventHandler.class.php:2253](../../projects/game-origin-php/src/game/EventHandler.class.php#L2253)
  ```php
...
- **Статус**: verified
- **Где**: [src/game/Functions.inc.php:41-54](../../projects/game-origin-php/src/game/Functions.inc.php#L41-L54)
...
- **Статус**: **patched** (NS::acquireLock на userid TTL=5s в начале sendFleet)
- **Где**: [src/game/page/Mission.class.php:1361-1390](../../projects/game-origin-php/src/game/page/Mission.class.php#L1361-L1390),
  [src/game/page/Mission.class.php:354-360](../../projects/game-origin-php/src/game/page/Mission.class.php#L354-L360)
- **Verification**:
...
- **Статус**: verified
- **Где**: [src/game/page/StockNew.class.php:622-647](../../projects/game-origin-php/src/game/page/StockNew.class.php#L622-L647)
...
- **Статус**: **patched** (тот же lock что LIM-001 — sendFleet на userid)
- **Где**: [src/game/page/Mission.class.php:1387-1390](../../projects/game-origin-php/src/game/page/Mission.class.php#L1387-L1390)
...
|---|---|---|---|
| **OVF-004** | P1 | **patched** | trivial (1 строка) |
| **REF-005** | P1 | **patched** | small (атомарный UPDATE + check) |
| **STUCK-001** | P1 | **patched** | trivial (Exception → \\Throwable) |
| RACE-003 | P1 | **patched** (acquireLock в 3 файлах) | medium |
| RACE-004 | P1 | verified | medium (рефакторинг updateUserRes) |
| STUCK-002 | P1 | verified, fix не trivial | medium (race с воркером) |
| STUCK-003 | P2 | **patched (порог 14d→3d)**, recovery отдельно | small + medium |
| REF-004 | P2 | **patched** | small (атомарный status-update) |
| LIM-001 | P2 | **patched** (acquireLock на userid) | medium |
| LIM-003 | P2 | **patched** (тот же lock что LIM-001) | medium |
