...
## Статус: В РАБОТЕ (задачи 0–4 выполнены, задача 5 — P3)
...
|---|--------|-----------|--------|
| 0 | Исправить вёрстку карточек | P1 КРИТ | S |
| 1 | Отмена задания в очереди (cancel) | P1 | M |
| 2 | Описание юнита на карточке | P1 | S |
| 3 | Скорость и расход топлива | P2 | S |
| 4 | Фильтр «Доступные / Все» | P2 | S |
| 5 | Rapidfire в UnitInfoScreen | P3 | M |
