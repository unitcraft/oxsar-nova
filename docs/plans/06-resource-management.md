...
- **Переработка (2026-04-23):** вместо expand-under-row — модальная плашка (`ox-modal-overlay` + `ox-modal`) поверх страницы с названием здания, slider и пресетами

**Статус:** [x] реализовано (2026-04-23) — переработано: вместо expand под строкой — модальная плашка (2026-04-23)
