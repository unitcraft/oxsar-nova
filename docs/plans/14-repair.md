...
## Статус: ЗАВЕРШЁН (задачи 1–4 выполнены)
...
| **Хранилище ремонта (repair_storage)** | ✅ | Storage в List ответе + progress-bar в шапке |
| **Требования на карточке юнита** | ✅ | 🔒 из catalog.requires, кнопка дизейблится |
| **Скорость и топливо для кораблей** | ✅ | 🚀 speed ⛽ fuel в карточках разбора |
...
| 2 | Хранилище ремонта в шапке | ✅ | S (backend поле + frontend ui) |
| 3 | Скорость и топливо на карточке | ✅ | S (только frontend) |
| 4 | Требования на карточке | ✅ | S (только frontend из catalog) |
