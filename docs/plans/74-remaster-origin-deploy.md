# План 74 (ремастер): origin deploy + DNS + config
...
начать играть в origin (классику oxsar2) на новом стеке.
...
- Не миграцируем игроков из game-legacy-php в новую origin —
  это fresh start (см. план 62, 0 игроков сейчас).
- Не выключаем game-legacy-php сразу — он работает на :8092 как
...
- План 50 — game-legacy-php юр-готов (на :8092 fallback).
