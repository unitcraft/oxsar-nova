...
🚫 Пропуск R8 Prometheus / R9 Idempotency / R12 i18n / R10
   universe_id — НЕ trade-off, обязательны со старта.
✅ Trade-off: импорт всех ~100 ачивок может потребовать разбиения
   на коммиты (по группам); это ок с обоснованием в simplifications.md.
